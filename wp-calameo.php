...
function calameo_render( $tags )
{
	...
	$html .= '<embed src="' . $viewer_url . '" type="application/x-shockwave-flash" style="width:' . $attributes['width'] . $attributes['widthUnit'] . ';height:' . $attributes['height'] . $attributes['heightUnit'] . '" flashvars="' . $flashvars . '" allowfullscreen="true" menu="false" ' . ( !empty($attributes['wmode']) ? 'wmode="' . $attributes['wmode'] . '"' : '' ) . ' />';
	$html .= '</object>';
